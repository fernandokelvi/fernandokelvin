            ...
            <div class="container">
                <div class="row">
                 <?php
                  ...
                  // $sql = "INSERT INTO `pessoas` ( `nome`, `sobrenome`, `data_nasc`, `email`, `telefone`, `CPF`) VALUES ('$nome','$sobrenome','$data_nasc','$email','$telefone','$CPF')";
                  $sql = "UPDATE `pessoas` set `nome` = '$nome', `sobrenome` = '$sobrenome', `data_nasc` = '$data_nasc0', `email` = '$email', `telefone` = '$telefone', `CPF` = '$CPF' WHERE cod_pessoa = $id)
